...
if (strpos($route, "/check") !== false) {

$license_data = $this->get_license();
if($license_data['status'] == 'activate'){
return array("success"=> true, "key"=>$license_key, "status"=>"activate", "remaining"=>1000, "activation_limit"=>1000, "expiry_days"=>1000);
} else {
return array("success"=>false);
}
} elseif (strpos($route, "/activate") !== false) {
return array("success"=> true, "key"=>$license_key, "status"=>"activate", "remaining"=>1000, "activation_limit"=>1000, "expiry_days"=>1000);
} elseif(strpos($route, "/deactivate") !== false) {
