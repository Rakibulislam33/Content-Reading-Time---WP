...
//        Don't Remove this line
	...
	public function dnxte_change_active_func( $post_id ) {
		...
		$nonce   = isset( $_GET['dnxte_popup_nonce'] ) ? sanitize_text_field( $_GET['dnxte_popup_nonce'] ) : '';
		$action  = isset( $_GET['dnxte_popup_action'] ) ? sanitize_text_field( $_GET['dnxte_popup_action'] ) : '';
		$post_id = isset( $_GET['post_id'] ) || wp_verify_nonce( sanitize_key( $nonce ), $action ) ? sanitize_text_field( $_GET['post_id'] ) : '';
